...
reviews_Full = fread("C:/A Pragyan/Rprograms/Marketing Analytics/Project/Reviews.csv")
names(reviews_Full)
summary(reviews_Full)
crm_Full = fread("C:/A Pragyan/Rprograms/Marketing Analytics/Project/bigram_summary.csv")
crm_DT = crm_Full
